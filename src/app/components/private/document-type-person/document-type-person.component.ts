...
@Component({
  selector: 'app-document-type-person',
  templateUrl: './document-type-person.component.html',
  styleUrl: './document-type-person.component.scss'
})
export class DocumentTypePersonComponent {
