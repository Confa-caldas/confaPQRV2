...
@Component({
  ...
  templateUrl: './requests-report-external.component.html',
  styleUrl: './requests-report-external.component.scss',
})
export class RequestsReportExternalComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.cols = [
      ...
      { field: 'user_name_completed', header: 'Responsable solicitud' },
