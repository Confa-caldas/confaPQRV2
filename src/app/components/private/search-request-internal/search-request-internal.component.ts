...
@Component({
  selector: 'app-search-request-internal',
  templateUrl: './search-request-internal.component.html',
  styleUrl: './search-request-internal.component.scss',
})
export class SearchRequestInternalComponent implements OnInit {
  ...
  getRequestListByFilter(payload: FilterRequests) {
    this.userService.getRequestInternalListByFilter(payload).subscribe({
