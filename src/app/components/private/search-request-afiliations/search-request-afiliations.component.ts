...
export class SearchRequestAfiliationsComponent implements OnInit {
  ...
  redirectDetails(solicitud_id: number) {
    ...
    this.router.navigate([RoutesApp.REQUEST_DETAILS_AFILIATION, solicitud_id]);
  }
